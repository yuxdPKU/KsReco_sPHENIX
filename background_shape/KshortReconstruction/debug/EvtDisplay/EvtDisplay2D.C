...
void EvtDisplay2D(int M_runNumber = 53744, int M_eventNumber = 6, int M_trackid1 = 12, int M_trackid2 = 41){
  ...
  gr_clus_track1_xy->GetXaxis()->SetLimits(-80, 80);
  gr_clus_track1_xy->SetMinimum(-80);
  gr_clus_track1_xy->SetMaximum(80);
  ...
  can_xy->Update();
  can_xy->SaveAs(Form("figure/EvtDisplay_run%d_event%d_trkid_%d_%d_xy.pdf",M_runNumber,M_eventNumber,M_trackid1,M_trackid2));
  ...
  gr_clus_track1_rz->GetXaxis()->SetLimits(-100, 100);
  gr_clus_track1_rz->SetMinimum(0);
  gr_clus_track1_rz->SetMaximum(80);
  ...
  can_rz->Update();
  can_rz->SaveAs(Form("figure/EvtDisplay_run%d_event%d_trkid_%d_%d_rz.pdf",M_runNumber,M_eventNumber,M_trackid1,M_trackid2));
