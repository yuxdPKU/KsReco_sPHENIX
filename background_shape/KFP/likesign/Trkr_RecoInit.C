...
std::cout<<"Hey!!! set static correction scale factor to 0.0"<<std::endl;
      tpcLoadDistortionCorrection->set_scale_factor(TpcLoadDistortionCorrection::DistortionType_Static, 0.0);
    }
