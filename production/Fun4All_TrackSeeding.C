...
void Fun4All_TrackSeeding(
    ...
    const std::string dir = "/sphenix/lustre01/sphnxpro/production/run2pp/physics/ana461_2024p009_v001/DST_TRKR_CLUSTER/run_00053700_00053800/dst/",
...
{
  std::string inputclusterFile = dir + clusterfilename;
