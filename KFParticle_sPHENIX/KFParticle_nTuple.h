...
class KFParticle_nTuple : public KFParticle_truthAndDetTools
{
 ...
 private:
  ...
  float m_calculated_mother_SV_x = -1;
  float m_calculated_mother_SV_y = -1;
  float m_calculated_mother_SV_z = -1;
  ...
  float m_calculated_intermediate_SV_x[max_intermediates] = {0};
  float m_calculated_intermediate_SV_y[max_intermediates] = {0};
  float m_calculated_intermediate_SV_z[max_intermediates] = {0};
