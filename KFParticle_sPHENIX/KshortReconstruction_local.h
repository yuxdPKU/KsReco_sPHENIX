#ifndef KSHORTRECONSTRUCTION_LOCAL_H
#define KSHORTRECONSTRUCTION_LOCAL_H
...
class KshortReconstruction_local : public SubsysReco
{
 public:
  KshortReconstruction_local(const std::string& name = "KshortReconstruction_local");
  virtual ~KshortReconstruction_local() {}
...
#endif  // KSHORTRECONSTRUCTION_LOCAL_H
